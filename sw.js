const CACHE='meu-controle-v2-14';
const ASSETS=[
  './','./index.html','./style.css','./app.js','./mobile-launches.js','./mobile-agenda.js','./mobile-settings.js','./profile-flex.js','./navigation-state.js','./manifest.json',
