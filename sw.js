const CACHE='meu-controle-v2-15';
const ASSETS=[
  './','./index.html','./style.css','./app.js','./mobile-launches.js','./mobile-agenda.js','./mobile-settings.js','./profile-flex.js','./navigation-state.js','./firebase-bridge.js','./manifest.json',
