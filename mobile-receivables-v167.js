/* Meu Controle — V1.68: card “A receber” + Painel mobile mais compacto */
(()=>{
 ...
 function css(){if(document.getElementById('mcMobileReceivablesV167Style'))return;const s=document.createElement('style');s.id='mcMobileReceivablesV167Style';s.textContent=`@media(max-width:700px){
  ...
  #dashboardPage .premium-card.today-card{min-height:132px!important;padding:14px 20px!important}
  #dashboardPage .premium-card.today-card .premium-label{margin-bottom:5px!important}
  #dashboardPage .premium-card.today-card #dashTodayMain{margin:0 0 5px!important;font-size:45px!important}
