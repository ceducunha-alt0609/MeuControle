/* Meu Controle — V1.73: recebimentos com apenas Editar e Concluir */
(()=>{
 ...
 function css(){if(document.getElementById('mcMobileReceivablesV167Style'))return;const s=document.createElement('style');s.id='mcMobileReceivablesV167Style';s.textContent=`@media(max-width:700px){
  ...
  #dashboardDetailModal.mc-receivables-detail-v173 #dashboardDetailList .item-value{color:#13713d!important}
  #dashboardDetailModal.mc-receivables-detail-v173 #dashboardDetailList .actions button:nth-child(n+3){display:none!important}
  #dashboardDetailModal.mc-receivables-detail-v173 #dashboardDetailList .item{overflow:hidden!important}
  #dashboardDetailModal.mc-receivables-detail-v173 #dashboardDetailList .actions{max-width:212px!important;overflow:visible!important}
  ...
  body.mc-dark #dashboardDetailModal.mc-receivables-detail-v173 #dashboardDetailList .item-value{color:#71d79b!important}
