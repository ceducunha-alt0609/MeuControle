...
(function(){
 ...
 @media(min-width:701px){
  ...
  body.mc-dark #settingsPage .mc-help-card-v037 details[open] summary{color:#edf3f6!important}
  body.mc-dark #settingsPage .mc-help-card-v037 details p{color:#aebbc3!important}
  body.mc-dark #settingsPage .mc-replay-tour-v037{background:#1d5f8b!important;color:#fff!important;border-color:#2d719d!important}
  body.mc-dark #settingsPage .mc-appdiag-v042{background:#1b272e!important;border-color:#40505a!important}
  body.mc-dark #settingsPage .mc-appdiag-head-v042:hover{background:#202e35!important}
  ...
  body.mc-dark #settingsPage .mc-help-card-v037 [class*="session"],body.mc-dark #settingsPage .mc-help-card-v037 [class*="exit"]{background:#1b272e!important;border-color:#40505a!important}
  body.mc-dark #settingsPage .mc-help-card-v037 [class*="session"] strong,body.mc-dark #settingsPage .mc-help-card-v037 [class*="exit"] strong{color:#edf3f6!important}
